...
class TagManagerController extends Controller
{
    ...
    {
         $this->middleware('permission:goole-tag-list|goole-tag-create|goole-tag-edit|goole-tag-delete', ['only' => ['index','store']]);
         $this->middleware('permission:goole-tag-create', ['only' => ['create','store']]);
